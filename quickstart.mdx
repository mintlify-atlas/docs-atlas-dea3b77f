...
<CardGroup cols={2}>
  <Card title="Query Options" icon="sliders" href="/query-options">
    Configure caching, refetching, and retry behavior
  </Card>
  
  <Card title="Mutations" icon="pen" href="/mutations">
    Learn how to create, update, and delete data
  </Card>
  
  <Card title="Query Invalidation" icon="refresh" href="/invalidation">
